...
| server (optional) | [`StreamingServers`](https://github.com/galaxywolfv/devanime-library/blob/master/src/models/types.ts#L76-L82) | takes server enum as a parameter. *default: [`StreamingServers.GogoCDN`](https://github.com/galaxywolfv/devanime-library/blob/master/src/models/types.ts#L76-L82)* |
